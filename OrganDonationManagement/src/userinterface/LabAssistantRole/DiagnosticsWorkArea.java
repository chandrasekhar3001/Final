...
public class DiagnosticsWorkArea extends javax.swing.JPanel {
    ...
    public DiagnosticsWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business) {
        initComponents();
    ...
    public void initWorktable() {
        ...
        model.setRowCount(0);
        for (WorkRequest request : diagnostics.getWorkQueue().getWorkRequestList()) {
            Object[] row = new Object[6];
            row[1] = ((LabTestWorkRequest) request).getPatient().getName();
    ...
    private void btn_processActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_processActionPerformed
        ...
        LabTestWorkRequest request = (LabTestWorkRequest) tbl_workReq.getValueAt(selectedRow, 0);
